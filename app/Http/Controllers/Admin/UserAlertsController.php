...
class UserAlertsController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = UserAlert::with(['users', 'lices_no'])->select(sprintf('%s.*', (new UserAlert())->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'user', 'lices_no']);
        ...
        return view('admin.userAlerts.index', compact('users', 'tasks'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.userAlerts.create', compact('lices_nos', 'users'));
    }
