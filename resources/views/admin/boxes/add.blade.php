                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.boxes.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" hidden name="minibller_no_id" value="{{$fouses->minibiler_id }}" ">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" disabled  value="{{$fouses->fouse_no}}" ">
                            <input type="text" hidden name="fouse_id" value="{{$fouses->id }}" ">
