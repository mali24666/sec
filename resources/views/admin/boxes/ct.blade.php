                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.boxes.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" disabled  value="{{$trans_cb_fider_number}}" ">
                            <input type="text"hidden  name="transformer_cb_id" value="{{$transformer_cbs->id}}" ">
                          ...
                          <div class="form-group {{ $errors->has('supply_type') ? 'has-error' : '' }}">
                            ...
                            <select  class="form-control" name="supply_type" id="supply_type">
                                ...
                                @foreach(App\Models\Box::SUPPLY_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('supply_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
