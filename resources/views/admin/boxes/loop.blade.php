...
add.blade.php ( ASCII text, with CRLF line terminators )
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.boxes.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="transformer_cb_id">transformer</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" hidden  name="minibller_no_id" value="{{$minibller_id }}" ">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" disabled  value="{{$fouse_id->fouse_no}}" ">
                            <input type="text" hidden name="fouse_id" value="{{$fouse_id->id }}" ">

                            @if($errors->has('fouse'))
                                <span class="text-danger">{{ $errors->first('fouse') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.box.fields.fouse_helper') }}</span>
         
                        <div hidden class="form-group {{ $errors->has('loop') ? 'has-error' : '' }}">
                                            ...
                                            <select class="form-control" name="loop" id="loop">
                                                ...
                                                @foreach(App\Models\Box::LOOP_SELECT as $key => $label)
                                                    <option value="{{ $key }}" {{ old('loop', '2') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                                @endforeach
                                            </select>
                                            @if($errors->has('loop'))
                        ...
                        <div class="form-group not_single {{ $errors->has('box_number_2') ? 'has-error' : '' }}">
                            <label for="box_number_2">{{ trans('cruds.box.fields.box_number_2') }}</label>
                            <input class="form-control" type="text" name="box_number_2" id="box_number_2" value="0">
                        ...
                        <div class="form-group not_single not_dubble  {{ $errors->has('box_number_3') ? 'has-error' : '' }}">
                            <label for="box_number_3">{{ trans('cruds.box.fields.box_number_3') }}</label>
                            <input class="form-control" type="text" name="box_number_3" id="box_number_3" value="0">
                        ...
                        <div class="form-group not_single not_dubble {{ $errors->has('box_number_4') ? 'has-error' : '' }}">
                            <label for="box_number_4">{{ trans('cruds.box.fields.box_number_4') }}</label>
                            <input class="form-control" type="text" name="box_number_4" id="box_number_4" value="0">
    ...
    // Listen for changes in the dropdown 
      $('#box_type').change(function () { 
        ...
        console.log(selectedOption);
            if (selectedOption == 1) {
            $('.not_single').addClass('hidden'); 

            }
            if  (selectedOption == 2) {
            $('.not_single').removeClass('hidden'); 

            $('.not_dubble').addClass('hidden'); 

            }
            if  (selectedOption == 4) {
            $('.not_dubble').removeClass('hidden'); 
            $('.not_single').removeClass('hidden'); 
