                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.boxes-details.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('subscription_number') ? 'has-error' : '' }}">
                            <label  for="subscription_number">{{ trans('cruds.boxesDetail.fields.subscription_number') }}</label>
                            <input disabled class="form-control" type="text"  id="subscription_number"
                            value="{{ $box_number}}" >
                            <input hidden class="form-control" type="text" name="subscription_number"
                            value="{{ $box_number}}" >
