        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.boxesDetail.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.boxes-details.update", [$boxesDetail->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('subscription_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="subscription_number" id="subscription_number" value="{{ old('subscription_number', $boxesDetail->subscription_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('cb') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="cb" id="cb" value="{{ old('cb', $boxesDetail->cb) }}">
                            @if($errors->has('cb'))
                        ...
                        <div class="form-group {{ $errors->has('rating') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="rating" id="rating" value="{{ old('rating', $boxesDetail->rating) }}">
                        ...
                        <div class="form-group {{ $errors->has('watcher') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="watcher" id="watcher" value="{{ old('watcher', $boxesDetail->watcher) }}">
                        ...
                        <div class="form-group {{ $errors->has('watch_size') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="watch_size" id="watch_size" value="{{ old('watch_size', $boxesDetail->watch_size) }}">
                        ...
                        <div class="form-group {{ $errors->has('ct_transe') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ct_transe" id="ct_transe" value="{{ old('ct_transe', $boxesDetail->ct_transe) }}">
                        ...
                        <div class="form-group {{ $errors->has('subscription_class') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="subscription_class" id="subscription_class">
                                ...
                                @foreach(App\Models\BoxesDetail::SUBSCRIPTION_CLASS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('subscription_class', $boxesDetail->subscription_class) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('absurdity') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="absurdity" id="absurdity">
                                ...
                                @foreach(App\Models\BoxesDetail::ABSURDITY_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('absurdity', $boxesDetail->absurdity) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('account_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="account_number" id="account_number" value="{{ old('account_number', $boxesDetail->account_number) }}">
