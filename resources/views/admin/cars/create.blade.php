    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cars.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car_number') ? 'is-invalid' : '' }}" type="number" name="car_number" id="car_number" value="{{ old('car_number', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('car_type') ? 'is-invalid' : '' }}" name="car_type" id="car_type">
                    ...
                    @foreach(App\Models\Car::CAR_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('car_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('moror_number') ? 'is-invalid' : '' }}" type="text" name="moror_number" id="moror_number" value="{{ old('moror_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('estmara_date') ? 'is-invalid' : '' }}" type="text" name="estmara_date" id="estmara_date" value="{{ old('estmara_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tameen') ? 'is-invalid' : '' }}" type="text" name="tameen" id="tameen" value="{{ old('tameen') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('modol') ? 'is-invalid' : '' }}" type="text" name="modol" id="modol" value="{{ old('modol', '') }}">
                @if($errors->has('modol'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('check') ? 'is-invalid' : '' }}" name="check" id="check">
                    ...
                    @foreach(App\Models\Car::CHECK_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('check', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('check'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('check_date') ? 'is-invalid' : '' }}" type="text" name="check_date" id="check_date" value="{{ old('check_date') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('taheel') ? 'is-invalid' : '' }}" name="taheel" id="taheel">
                    ...
                    @foreach(App\Models\Car::TAHEEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('taheel', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
