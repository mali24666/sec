                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.cbs.update", [$cb->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('transformer') ? 'has-error' : '' }}">
                            <label for="transformer_id">{{ trans('cruds.cb.fields.transformer') }}</label>
                            <select class="form-control select2" name="transformer_id" id="transformer_id">
                                @foreach($transformers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('transformer_id') ? old('transformer_id') : $cb->transformer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('transformer'))
                                <span class="help-block" role="alert">{{ $errors->first('transformer') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.cb.fields.transformer_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('trans_cb_fider_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="trans_cb_fider_number" id="trans_cb_fider_number" value="{{ old('trans_cb_fider_number', $cb->trans_cb_fider_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('minbilars') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="minbilars[]" id="minbilars" multiple>
                                @foreach($minbilars as $id => $minbilar)
                                    <option value="{{ $id }}" {{ (in_array($id, old('minbilars', [])) || $cb->minbilars->contains($id)) ? 'selected' : '' }}>{{ $minbilar }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('temperature') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="temperature" id="temperature" value="{{ old('temperature', $cb->temperature) }}">
                        ...
                        <div hidden class="form-group {{ $errors->has('temperature_refrence') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="temperature_refrence" id="temperature_refrence" value="{{ old('temperature_refrence', $cb->temperature_refrence) }}">
                        ...
                        <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="note" id="note">{!! old('note', $cb->note) !!}</textarea>
                            @if($errors->has('note'))
                           ...
                           <div class="form-group {{ $errors->has('load_y') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="load_y" id="load_y" value="{{ old('load_y', $cb->load_y) }}">
                        ...
                        <div class="form-group {{ $errors->has('load_b') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="load_b" id="load_b" value="{{ old('load_b', $cb->load_b) }}">
                        ...
                        <div class="form-group {{ $errors->has('load_r') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="load_r" id="load_r" value="{{ old('load_r', $cb->load_r) }}">
