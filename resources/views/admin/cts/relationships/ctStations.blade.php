    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-ctStations">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($stations as $key => $station)
                            <tr data-entry-id="{{ $station->id }}">
                                ...
                                <td>
                                    @foreach($station->cts as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-ctStations:not(.ajaxTable)').DataTable({ buttons: dtButtons })
