    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-startPointStationLines">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($lines as $key => $line)
                            <tr data-entry-id="{{ $line->id }}">
                                ...
                                <td>
                                    {{ $line->start_point_station->ct_no ?? '' }}
                                </td>
                                <td>
                                    {{ $line->end_point->ct_no ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-startPointStationLines:not(.ajaxTable)').DataTable({ buttons: dtButtons })
