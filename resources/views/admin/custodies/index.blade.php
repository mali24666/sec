...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Custody">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($tools as $key => $item)
                                    <option value="{{ $item->tool_name }}">{{ $item->tool_name }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\Custody::STUNTS_SELECT as $key => $item)
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\Custody::RECEIVED_SELECT as $key => $item)
                                    <option value="{{ $item }}">{{ $item }}</option>
                                @endforeach
                            </select>
                        </td>
...
@endcan
  ...
  let table = $('.datatable-Custody:not(.ajaxTable)').DataTable({ buttons: dtButtons })
