    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emp_name') ? 'is-invalid' : '' }}" type="text" name="emp_name" id="emp_name" value="{{ old('emp_name', $employee->emp_name) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('branch') ? 'is-invalid' : '' }}" name="branch" id="branch" required>
                    ...
                    @foreach(App\Models\Employee::BRANCH_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('branch', $employee->branch) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationlaty') ? 'is-invalid' : '' }}" type="text" name="nationlaty" id="nationlaty" value="{{ old('nationlaty', $employee->nationlaty) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emp') ? 'is-invalid' : '' }}" type="number" name="emp" id="emp" value="{{ old('emp', $employee->emp) }}" step="1" required>
                @if($errors->has('emp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('id_expire') ? 'is-invalid' : '' }}" type="text" name="id_expire" id="id_expire" value="{{ old('id_expire', $employee->id_expire) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('car') ? 'is-invalid' : '' }}" name="car_id" id="car_id">
                    @foreach($cars as $id => $entry)
                        <option value="{{ $id }}" {{ (old('car_id') ? old('car_id') : $employee->car->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('car'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('occupation') ? 'is-invalid' : '' }}" type="text" name="occupation" id="occupation" value="{{ old('occupation', $employee->occupation) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('occupation_agree') ? 'is-invalid' : '' }}" name="occupation_agree" id="occupation_agree">
                    ...
                    @foreach(App\Models\Employee::OCCUPATION_AGREE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('occupation_agree', $employee->occupation_agree) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('occupation_insite') ? 'is-invalid' : '' }}" type="text" name="occupation_insite" id="occupation_insite" value="{{ old('occupation_insite', $employee->occupation_insite) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('en_flow') ? 'is-invalid' : '' }}" name="en_flow_id" id="en_flow_id">
                    @foreach($en_flows as $id => $entry)
                        <option value="{{ $id }}" {{ (old('en_flow_id') ? old('en_flow_id') : $employee->en_flow->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('supervisor') ? 'is-invalid' : '' }}" name="supervisor_id" id="supervisor_id">
                    @foreach($supervisors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('supervisor_id') ? old('supervisor_id') : $employee->supervisor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
