    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.lics.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('esnad') ? 'is-invalid' : '' }}" type="text" name="esnad" id="esnad" value=" " required>
                @if($errors->has('esnad'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_length') ? 'is-invalid' : '' }}" type="text" name="e_length" id="e_length" value="{{ old('e_length', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('t_length') ? 'is-invalid' : '' }}" type="text" name="t_length" id="t_length" value="{{ old('t_length', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sarameek') ? 'is-invalid' : '' }}" type="text" name="sarameek" id="sarameek" value="{{ old('sarameek', '') }}" step="0.01">
