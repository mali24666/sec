    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.lics.update", [$lic->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input  class="form-control {{ $errors->has('e_length') ? 'is-invalid' : '' }}" type="text" name="e_length" id="e_length" value="{{ old('e_length', $lic->e_length) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input  class="form-control {{ $errors->has('t_length') ? 'is-invalid' : '' }}" type="text" name="t_length" id="t_length" value="{{ old('t_length', $lic->t_length) }}" step="1">
