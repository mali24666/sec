                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.minibllers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('cb') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="cb_id" id="cb_id">
                                @foreach($cbs as $id => $entry)
                                    <option value="{{ $id }}" {{ old('cb_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('cb'))
                        ...
                        <div class="form-group {{ $errors->has('minibller_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="minibller_number" id="minibller_number" value="{{ old('minibller_number', '') }}" required>
