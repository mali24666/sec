    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-transeMiniblarTranseformers">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($transeformers as $key => $transeformer)
                            <tr data-entry-id="{{ $transeformer->id }}">
                                ...
                                <td>
                                    {{ $transeformer->lv_cable->cable_size ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-transeMiniblarTranseformers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
