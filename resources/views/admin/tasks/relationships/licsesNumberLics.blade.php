                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-licsesNumberLics">
                    <thead>
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.lic.fields.head_eng') }}
                            </th>
                            <th>
                                {{ trans('cruds.lic.fields.eng_check') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($lics as $key => $lic)
                            <tr data-entry-id="{{ $lic->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $lic->eng_check ?? '' }}</span>
                                    <input type="checkbox" disabled="disabled" {{ $lic->eng_check ? 'checked' : '' }}>
                                </td>
                                <td>
