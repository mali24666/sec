...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tool.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tools.update", [$tool->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tool_name') ? 'is-invalid' : '' }}" type="text" name="tool_name" id="tool_name" value="{{ old('tool_name', $tool->tool_name) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('job') ? 'is-invalid' : '' }}" name="job" id="job">{{ old('job', $tool->job) }}</textarea>
                @if($errors->has('job'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $tool->price) }}" step="0.01">
                @if($errors->has('price'))
