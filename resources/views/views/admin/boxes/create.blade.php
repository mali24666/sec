    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.boxes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('box_number') ? 'is-invalid' : '' }}" type="text" name="box_number" id="box_number" value="{{ old('box_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('box_location') ? 'is-invalid' : '' }}" type="text" name="box_location" id="box_location" value="{{ old('box_location', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('box_notes') ? 'is-invalid' : '' }}" name="box_notes" id="box_notes">
                    ...
                    @foreach(App\Models\Box::BOX_NOTES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('box_notes', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
