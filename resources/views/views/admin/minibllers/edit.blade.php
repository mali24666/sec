    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.minibllers.update", [$minibller->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('cb_number') ? 'is-invalid' : '' }}" name="cb_number_id" id="cb_number_id">
                    @foreach($cb_numbers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('cb_number_id') ? old('cb_number_id') : $minibller->cb_number->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minibller_number') ? 'is-invalid' : '' }}" type="text" name="minibller_number" id="minibller_number" value="{{ old('minibller_number', $minibller->minibller_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minibller_x') ? 'is-invalid' : '' }}" type="text" name="minibller_x" id="minibller_x" value="{{ old('minibller_x', $minibller->minibller_x) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minibller_y') ? 'is-invalid' : '' }}" type="text" name="minibller_y" id="minibller_y" value="{{ old('minibller_y', $minibller->minibller_y) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text" name="longitude" id="longitude" value="{{ old('longitude', $minibller->longitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text" name="latitude" id="latitude" value="{{ old('latitude', $minibller->latitude) }}">
