    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transeformers.update", [$transeformer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('t_no') ? 'is-invalid' : '' }}" type="text" name="t_no" id="t_no" value="{{ old('t_no', $transeformer->t_no) }}" required>
                @if($errors->has('t_no'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kva_rating') ? 'is-invalid' : '' }}" type="text" name="kva_rating" id="kva_rating" value="{{ old('kva_rating', $transeformer->kva_rating) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_voltage') ? 'is-invalid' : '' }}" type="text" name="primary_voltage" id="primary_voltage" value="{{ old('primary_voltage', $transeformer->primary_voltage) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sec_voltage') ? 'is-invalid' : '' }}" type="text" name="sec_voltage" id="sec_voltage" value="{{ old('sec_voltage', $transeformer->sec_voltage) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manuf_sno') ? 'is-invalid' : '' }}" type="text" name="manuf_sno" id="manuf_sno" value="{{ old('manuf_sno', $transeformer->manuf_sno) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manufacturer') ? 'is-invalid' : '' }}" type="text" name="manufacturer" id="manufacturer" value="{{ old('manufacturer', $transeformer->manufacturer) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manafac_year') ? 'is-invalid' : '' }}" type="text" name="manafac_year" id="manafac_year" value="{{ old('manafac_year', $transeformer->manafac_year) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('over_load') ? 'is-invalid' : '' }}" type="text" name="over_load" id="over_load" value="{{ old('over_load', $transeformer->over_load) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="text" name="rating" id="rating" value="{{ old('rating', $transeformer->rating) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manufacturer_serial') ? 'is-invalid' : '' }}" type="text" name="manufacturer_serial" id="manufacturer_serial" value="{{ old('manufacturer_serial', $transeformer->manufacturer_serial) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('circuits') ? 'is-invalid' : '' }}" type="text" name="circuits" id="circuits" value="{{ old('circuits', $transeformer->circuits) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_used_circuits') ? 'is-invalid' : '' }}" type="text" name="no_of_used_circuits" id="no_of_used_circuits" value="{{ old('no_of_used_circuits', $transeformer->no_of_used_circuits) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manufacturer_minb') ? 'is-invalid' : '' }}" type="text" name="manufacturer_minb" id="manufacturer_minb" value="{{ old('manufacturer_minb', $transeformer->manufacturer_minb) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lv_cable') ? 'is-invalid' : '' }}" type="text" name="lv_cable" id="lv_cable" value="{{ old('lv_cable', $transeformer->lv_cable) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('x_minb') ? 'is-invalid' : '' }}" type="text" name="x_minb" id="x_minb" value="{{ old('x_minb', $transeformer->x_minb) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('y_minb') ? 'is-invalid' : '' }}" type="text" name="y_minb" id="y_minb" value="{{ old('y_minb', $transeformer->y_minb) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manuf') ? 'is-invalid' : '' }}" type="text" name="manuf" id="manuf" value="{{ old('manuf', $transeformer->manuf) }}">
                @if($errors->has('manuf'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('left_ss') ? 'is-invalid' : '' }}" type="text" name="left_ss" id="left_ss" value="{{ old('left_ss', $transeformer->left_ss) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('right_ss') ? 'is-invalid' : '' }}" type="text" name="right_ss" id="right_ss" value="{{ old('right_ss', $transeformer->right_ss) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('serial_no') ? 'is-invalid' : '' }}" type="text" name="serial_no" id="serial_no" value="{{ old('serial_no', $transeformer->serial_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $transeformer->type) }}">
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('cb_no') ? 'is-invalid' : '' }}" name="cb_no_id" id="cb_no_id">
                    @foreach($cb_nos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('cb_no_id') ? old('cb_no_id') : $transeformer->cb_no->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('cb_no'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text" name="latitude" id="latitude" value="{{ old('latitude', $transeformer->latitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text" name="longitude" id="longitude" value="{{ old('longitude', $transeformer->longitude) }}">
